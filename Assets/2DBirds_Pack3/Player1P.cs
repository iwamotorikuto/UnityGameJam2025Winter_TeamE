...
public class Player1PScript : MonoBehaviour
{
    private Vector2 startPos;
    private Vector2 endPos;
    private Rigidbody2D rb;

    [SerializeField] float power = 10f;　//ドラッグによる力の倍率
    [SerializeField] float maxDistance = 5f;　//ドラッグ距離の最大範囲
    [SerializeField] float minDistance = 0f;　//ドラッグ距離の最小範囲
